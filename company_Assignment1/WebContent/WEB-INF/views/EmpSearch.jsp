...
<link href="<c:url value="resource/Css/jquery-ui_date.css"/>" rel="stylesheet" type="text/css" />
<link href="<c:url value="resource/Css/chegus-infotech-style-Hie.css"/>" rel="stylesheet" type="text/css" />
<style type="text/css">
body {
    margin: 0;
    padding: 0;
...
<form:form action="save" method="post" modelAttribute="employee">
	<table cellpadding="0" cellspacing="0" class="mainTable" width="100%">
		<tbody>
			<tr>
				<td class="subHeaderText">Employee Details</td>
			</tr>
			<tr>
				<td>
					<table class="innerTable" cellpadding="0" cellspacing="0"
						id="dynTable">
						<tr>
							<td width="17%" class="">Employee ID</td>
							<td width="17%" class="">Employee Name</td>
							<td width="20%" class="">Gender</td>
							<td width="26%" class="">Mobile No</td>

						</tr>
						<tr>

							<td class=""><form:input type="text" path="eid" class="textStyle_130" style="height: 18px" /></td>
							<td class=""><form:input type="text" path="ename" class="textStyle_130" style="height: 18px" /></td>
							<td width="15%" class="">
								<form:select class="dropdown_Fixed140" path="egender">
									<form:option value="" selected="Selected">Select</form:option>
									<form:option value="Male">Male</form:option>
									<form:option value="Female">Female</form:option>
								</form:select>
							</td>
							<td class=""><form:input type="text" path="emobile" class="textStyle_80" style="height: 18px" /></td>
						</tr>
			...
			<tr>
				<div id="divbtns">
					<td class="createButton" align="right"><a href="#"> </a> 
					<a href="tariff.html"> </a>
					<td class="createButton" align="right"></td>
					</td>
				</div>
			</tr>
			...
			<tr>
				<td class="createButton" align="right"><div id="divbtns">
						<input type="submit" value="Submit" class="create" title="Submit" />
						<a href="./"><input type="button" value="Cancel" title="Cancel" /></a>
						<a href="./resetEmployee.html"><input type="button" value="Reset" title="Reset" /></a>
					</div></td>
			</tr>
