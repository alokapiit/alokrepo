...
<link href="./Css/chegus-infotech-style-Hie.css" rel="stylesheet"
	type="text/css" />
...
<body>
	<form:form action="save1" method="post" modelAttribute="company">
		<table width="100%" height="34" cellpadding="0" cellspacing="0" class="mainTable">
			<tr>
				<td class="subHeaderText">Company</td>
			</tr>
			<tr>
				<td>
					<table class="innerTable" cellpadding="0" cellspacing="0">
						<tr>
							<td width="14%" class="">Company ID</td>
							<td width="15%" class="">Company Name</td>
							<td width="15%" class="">Location</td>
						</tr>
						<tr>
							<td width="14%" class=""><form:input path="cid" type="text"
								class="textStyle_130"/></td>
							<td width="14%" class=""><form:input path="cname" type="text"
								class="textStyle_130"/></td>
							<td width="14%" class=""><form:input path="clocation" type="text"
								class="textStyle_130"/></td>
						<tr>
							<td colspan="8">
												...
												<fieldset>
													...
													<table style="width: 100%">
														<tbody>
															<tr>
															<tr>
																<td width="14%" class="">Employee</td>
																<td style="width: 1%">

																	<div>
																		<a href="#" class="AddBtn"
																			onClick="addrow('contctNotifyTbl')">Add</a>
																	</div>
															</tr>
                     
					      <tr>
							 <td width="11%" class="">
									<form:select class="dropdown_Fixed140" path="employee.eid">
									<c:forEach items="${listEmployee}" var="comp">
										<form:option value="${comp.eid}">${comp.ename}</form:option>
									</c:forEach>
									</form:select>
							 </td>
							 <td align="center">
									<div align="left">
										<a href="#" id="delete"><img src="../../images/delete.png" width="10" height="10" border="0" /></a>
									</div>
							   </td>
							</tr>
		...
		<tr>
		<td class="createButton" align="right"><div
				style="padding-top: 7px" id="divbtns">

				<td class="createButton" align="right"><div id="divbtns">
						<input type="submit" value="Submit" class="create" title="Submit" /><a
							href="./"><input type="button" value="Cancel" title="Cancel" /></a>
					</div></td>
				</td>
				</tr>
	</form:form>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#drCessiontypes").change(function() {

			if ($("#drCessiontypes").val() == "0") {
				$("#Facu").hide();
				$("#Facu1").hide();
				$("#Facu2").hide();
				$("#Facu3").hide();
				$("#Facu4").hide();
				$("#Facu5").hide();
			} else if ($("#drCessiontypes").val() == "1") {
				$("#Facu").show();
				$("#Facu1").show();
			}
			if ($("#drCessiontypes").val() == "1") {
				$("#Facu2").hide();
				$("#Facu3").hide();
				$("#Facu4").hide();
				$("#Facu5").hide();
